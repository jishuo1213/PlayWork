 ...
 */
public class UpdateAccountStep3Activity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        contentEditText.setHint("请输入新手机号");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_left:
                ...
                break;
            case R.id.tv_right:
                startActivity(new Intent(UpdateAccountStep3Activity.this,
                        UpdateAccountStep4Activity.class));
                break;
        }
    }
}

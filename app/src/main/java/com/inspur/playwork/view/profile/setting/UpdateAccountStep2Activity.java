 ...
 */
public class UpdateAccountStep2Activity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        contentEditText.setHint("请输入登录密码");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_left:
                ...
                break;
            case R.id.tv_right:
                startActivity(new Intent(UpdateAccountStep2Activity.this,
                        UpdateAccountStep3Activity.class));
                break;
        }
    }
}

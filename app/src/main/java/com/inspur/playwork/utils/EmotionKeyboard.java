...
//        }
        hideSoftInput();
        mEmotionLayout.getLayoutParams().height = PreferencesHelper.getInstance().readIntPreference(PreferencesHelper.INPUT_HEIGHT);
...
//        return PreferencesHelper.getInstance().readIntPreference(PreferencesHelper.INPUT_HEIGHT);
    }
